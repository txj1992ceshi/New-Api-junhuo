...
const (
	...
	ContextKeyResponsesStatefulRequested          ContextKey = "responses_stateful_requested"
	ContextKeyResponsesStatefulCapability         ContextKey = "responses_stateful_capability"
	ContextKeyResponsesStatefulNativeUsed         ContextKey = "responses_stateful_native_used"
	ContextKeyResponsesStatefulReplayUsed         ContextKey = "responses_stateful_replay_used"
	ContextKeyResponsesEntityLookupHit            ContextKey = "responses_entity_lookup_hit"
	ContextKeyResponsesEntityLookupMiss           ContextKey = "responses_entity_lookup_miss"
	ContextKeyResponsesFallbackFromNativeToReplay ContextKey = "responses_fallback_from_native_to_replay"
	ContextKeyResponsesEntityID                   ContextKey = "responses_entity_id"
